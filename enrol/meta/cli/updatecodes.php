    ...
    while ($rows = mysqli_fetch_array($res)) {
        ...
        if ($resource == false) {
            ...
            if ($resource_parent == false) {
                ...
                fwrite($log,"<span style=\"color: #800000;\">Unable to find new occurrence ($new_occ) of $course_code for meta course <a href=\"".$CFG->wwwroot."/enrol/instances.php?id=".$parent_id."\" target=\"_blank\">$shortname</a>.</span><br />");
                $fail++;
            }
        } else {
            ...
            if ($resource == false) {
                ...
                if ($resource_parent == false) {
                    ...
                    fwrite($log,"<span style=\"color: #008000;\">Successfully updated meta course <a href=\"".$CFG->wwwroot."/enrol/instances.php?id=".$parent_id."\" target=\"_blank\">$shortname</a> with new child course $new_code (start date $start_date).</span><br />");
                    $success++;
                }
            }

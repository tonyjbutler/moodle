...
function &get_mimetypes_array() {
    static $mimearray = array (
        ...
        'key'  => array ('type'=>'application/x-iwork-keynote-sffkey', 'icon'=>'impress', 'groups'=>array('presentation')),
        ...
        'numbers'   => array ('type'=>'application/x-iwork-numbers-sffnumbers', 'icon'=>'calc', 'groups'=>array('spreadsheet')),
        ...
        'pages'=> array ('type'=>'application/x-iwork-pages-sffpages', 'icon'=>'writer', 'groups'=>array('document')),

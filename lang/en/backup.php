...
$string['skipnotmodifsincedays'] = 'Skip courses not modified since';
$string['skipnotmodifsincedayshelp'] = 'Choose to skip courses that have not been modified since a number of days';
$string['skipnotmodifsinceprevious'] = 'Skip courses not modified since previous backup';
$string['skipnotmodifsinceprevioushelp'] = 'Choose whether or not to skip courses that have not been modified since previous backup';

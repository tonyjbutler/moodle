...
$string['aggregatecountbutton'] = '"{$a->rating}" rating: {$a->count}';
...
$string['buttonicon'] = 'Button icon';
$string['buttonicon_help'] = 'If using a customisable button, this is the icon to be displayed on it.';
$string['buttontext'] = 'Button text';
$string['buttontext_help'] = 'If using a customisable button, this is the text to be displayed on it.';
...
$string['plusone'] = '+1';
$string['rate'] = 'Rate';
$string['ratecolon'] = 'Rate: ';
$string['rateellipsis'] = 'Rate...';
...
$string['scaledesc'] = 'Single-item scale "{$a}" for use with toggle button ratings.';
...
$string['toggleratingon'] = 'Award "{$a}" rating';
$string['toggleratingoff'] = 'Remove "{$a}" rating';
$string['uibutton'] = 'Toggle button';
$string['uiselect'] = 'Drop-down menu';
$string['ui'] = 'User interface';
$string['ui_help'] = 'Choose either the standard ratings menu, or a customisable button to register/unregister a single rating (e.g. "Like" or "Useful").';

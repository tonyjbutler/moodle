...
function theme_clean_get_html_for_settings(renderer_base $output, moodle_page $page) {
    ...
    if (!empty($page->theme->settings->logo) && $page->bodyid == 'page-site-index') {
        $return->heading = html_writer::link($CFG->wwwroot, '', array('title' => get_string('home'), 'class' => 'logo')).
                html_writer::link('http://www.blackpool.ac.uk', '', array('title' => 'B&FC Home', 'target' => '_blank', 'class' => 'bfc-logo'));
    } else {

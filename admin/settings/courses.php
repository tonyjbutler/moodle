...
/// Pending course requests.
    ...
    $temp->add(new admin_setting_configselect('backup/backup_auto_skip_modif_days', get_string('skipmodifdays', 'backup'), get_string('skipmodifdayshelp', 'backup'), 30, array(
        0 => get_string('never'),
        1 => get_string('numdays', '', 1),
        2 => get_string('numdays', '', 2),
        3 => get_string('numdays', '', 3),
    ...
    $temp->add(new admin_setting_configcheckbox('backup/backup_auto_skip_modif_prev', get_string('skipmodifprev', 'backup'), get_string('skipmodifprevhelp', 'backup'), 0));

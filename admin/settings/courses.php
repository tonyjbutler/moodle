...
/// Pending course requests.
    ...
    $temp->add(new admin_setting_configselect('backup/backup_auto_skip_not_modif_since_days', new lang_string('skipnotmodifsincedays', 'backup'), new lang_string('skipnotmodifsincedayshelp', 'backup'), 30, array(
    ...
    $temp->add(new admin_setting_configcheckbox('backup/backup_auto_skip_not_modif_since_prev', new lang_string('skipnotmodifsinceprevious', 'backup'), new lang_string('skipnotmodifsinceprevioushelp', 'backup'), 0));

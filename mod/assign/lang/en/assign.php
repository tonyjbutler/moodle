...
$string['calculatedgraderubric'] = 'Calculated grade';
$string['calculatedgraderubric_help'] = 'This is the grade calculated by the rubric above (save changes to recalculate). This grade can be overridden by updating the grade below. To use the calculated grade again just remove the override grade (it will be cleared automatically if the rubric is updated).';

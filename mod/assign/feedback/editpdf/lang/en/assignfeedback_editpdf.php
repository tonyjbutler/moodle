...
$string['commenttransparency'] = 'Annotation comment transparency';
$string['commenttransparency_help'] = 'The degree of background transparency with which annotated PDF comments will be displayed, from 0% (fully opaque) to 50% transparent.';
$string['commenttransparencydesc'] = 'Default background transparency of comments, where 0% is fully opaque.';

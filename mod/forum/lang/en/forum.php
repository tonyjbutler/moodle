...
$string['autodeletion'] = 'Automatic deletion of stale discussions';
$string['autodeletionconfigured'] = 'Any discussions in this forum that have been inactive for more than {$a} will be automatically deleted.';
...
$string['deleteperiod'] = 'Maximum period of inactivity';
$string['deleteperiod_help'] = 'If enabled, all posts in a discussion thread will be automatically deleted after the specified period of inactivity.';
$string['deleteperiodinvalid'] = 'The inactivity period before deletion must be at least {$a}.';
...
$string['forum:deletediscussions'] = 'Configure auto-deletion of stale discussions';

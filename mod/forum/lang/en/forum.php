...
$string['autohiding'] = 'Automatic hiding of stale discussions';
$string['autohidingconfigured'] = 'Any discussions in this forum that have been inactive for more than {$a} will be automatically hidden.';
...
$string['hideperiod'] = 'Maximum period of inactivity';
$string['hideperiod_help'] = 'If enabled, all posts in a discussion thread will be automatically hidden after the specified period of inactivity.';
$string['hideperiodinvalid'] = 'The inactivity period before hiding posts must be at least {$a}.';
...
$string['forum:hidediscussions'] = 'Configure auto-hiding of stale discussions';

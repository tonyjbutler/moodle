...
//Courses/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		try 
		{
			...
			switch($moodleVersion)
			{
				...
				case "2.3":
					$courseQuery = sprintf("SELECT DISTINCT cs.id, cs.category, cs.shortname, cs.fullname, cs.summary
											FROM mdl_context C, mdl_role_assignments R, mdl_course CS
					...
					switch($moodleVersion)
					{
						...
						case "2.3":	
							$teacherQuery = sprintf("SELECT U.id, U.username, U.firstname, U.lastname
													 FROM mdl_role_assignments RA, mdl_context C, mdl_user U, mdl_role R
			...
			{
				throw new Exception ("Could not get courses");
			}
